...
import asyncio, json, random, sys, time, urllib.request, urllib.error
...
model=sys.argv[6]
runtime=sys.argv[7]
random_stress=bool(int(sys.argv[8]))
seed=int(sys.argv[9])
input_min=int(sys.argv[10])
input_max=int(sys.argv[11])
output_min=int(sys.argv[12])
output_max=int(sys.argv[13])
